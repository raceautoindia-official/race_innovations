...
function LoanForm() {
  ...
  const [selfOwned, setSelfOwned] = useState(null);
  const [parentOwned, setParentOwned] = useState(null);
  const [rented, setRented] = useState(null);
  const [monthsInResidence, setMonthsInResidence] = useState(null);
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="col-md-6 mb-3">
        ...
        <div className="col-md-6 mb-3">
          <label className="form-label">
            Complete Property Documents <span style={{ color: "red" }}>*</span>
          </label>
          <input
            type="file"
