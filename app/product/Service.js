...
function Service() {
  ...
  // Slide-in animation (Bottom to Top)
  ...
  const services = [
    ...
    { img: "/images/3.png", title: "Product & Concept Testing", desc: "Validate new products, services, and technologies before market launch." },
    ...
    { img: "/images/4.png", title: "Consumer & End-User Insights", desc: "Understand customer needs, pain points, and preferences through surveys." },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#293BB1", marginLeft: "15px" }}>Research Services</span>
      </motion.h4>
